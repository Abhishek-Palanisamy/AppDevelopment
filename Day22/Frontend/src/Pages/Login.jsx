  ...
  const authenticate = async (e) => {
    ...
    try {
      if (username && password) {
        ...
        const response = await axios.post("http://localhost:8081/auth/authentication", loginData);
    ...
    <div class="login-page1">
      <div class="login1">
        ...
        <form class="form-login1" type="submit" onSubmit={authenticate}>
          ...
          <button type="submit">
            <LoginIcon sx={{ color: 'white' }} fontSize='medium' color='success' className='icon' />
            Login
          </button>
